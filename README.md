...
| Região         | Tamanho   |
|----------------|-----------|
| [Centro-Oeste](https://github.com/cnpjbrazil/OUT-2024-CENTRO-OESTE/)   | 2.00 GB   |
| [Nordeste](https://github.com/cnpjbrazil/OUT-2024-NORDESTE/)       | 3.6 GB   |
| [Norte](https://github.com/cnpjbrazil/OUT-2024-NORTE/)          | 0.70 GB   |
| [Sudeste](https://github.com/cnpjbrazil/OUT-2024-SUDESTE/)         | 5.80 GB   |
| [Sul](https://github.com/cnpjbrazil/OUT-2024-SUL/)             | 2.20 GB   |

---

## Resumo das Tabelas e Registros

- **EMPRESAS**: 59.954.872 registros
- **ESTABELECIMENTOS**: 53.476.799 registros
- **SIMPLES**: 40.772.961 registros
- **SÓCIOS**: 24.811.418 registros
